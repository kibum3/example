...
<h2>
	<spring:message code="pds.header.list" />
</h2>
		...
		<c:otherwise>
			<c:forEach items="${itemList}" var="item">
				<tr class="record">
					...
					<sec:authorize access="hasRole('ROLE_ADMIN')">
						<td align="center"><a
							href="/pds/modify?itemId=${item.itemId}"><spring:message
									code="pds.edit" /></a></td>
						<td align="center"><a
							href="/pds/remove?itemId=${item.itemId}"><spring:message
									code="pds.remove" /></a></td>
					</sec:authorize>
				</tr>
			</c:forEach>
		</c:otherwise>
